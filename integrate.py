...
def QOCC_Augmented_Lagrangian(Cost_N, Cost_p, Constraint_N, Constraint_p, x0, QP_solver, contact_static_fric, tolerance, eta0=1e-4,eta_max=1e5, tau_eta=10):
    '''
...
def integrate(q, v, params, random_initial=False, warm_x=np.array([])):
    ...
    print("Build = %.2e, Form = %.2e, Solve = %.2e, Update = %.2e, "%(buildB_time,form_time,solve_time,update_time))
